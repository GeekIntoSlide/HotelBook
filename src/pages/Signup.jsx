  ...
  return (
    <React.Fragment>
      ...
      <div className='flex justify-between ml-[40px] mt-[80px]'>
        ...
        <input type="text" placeholder='Full Name' className={`block w-[400px] border-2 mb-[10px] h-[40px] border-sky-500` } />
          <input type="email" placeholder='Email address' className={`block w-[400px] border-2 mb-[10px] h-[40px] border-sky-500` } />
          <input type="password" placeholder="Password" className='block w-[400px] border-2 mb-[10px] h-[40px] border-sky-500'/>
          <span className='mb-[10px] cursor-pointer'>Have an account?</span>
          <span className='ml-[5px] text-red-400 mb-[10px] cursor-pointer' onClick={()=>navigate('/sign-in')}>Sign-In</span>
          <span className='ml-[80px] mb-[10px] text-cyan-400 mb-[10px] cursor-pointer' onClick={()=>navigate('/forgot-password')}>Forgot Password? </span>
